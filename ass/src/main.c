...
int main()
{
    ...
    write64bits_dram(va2pa(0x7ffffffee210), 0x8000600); // rbp
    ...
    write64bits_dram(va2pa(0x7ffffffee1f0), 0x8000600); // rsp
    ...
    match = match && (read64bits_dram(va2pa(0x7ffffffee210)) == 0x8000600);
